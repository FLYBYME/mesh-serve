...
export const apiTokenSchema = z.object({
  ...
  createdAt: z.coerce.date().describe('When the token was created'),
  lastUsedAt: z.coerce.date().optional().describe('When the token was last used'),
  expiresAt: z.coerce.date().optional().describe('When the token expires'),
  revokedAt: z.coerce.date().optional().describe('When the token was revoked'),
