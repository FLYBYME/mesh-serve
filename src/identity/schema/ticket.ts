...
export const ticketSchema = z.object({
  ...
  issuedAt: z.date().describe('When the ticket was issued'),
  expiresAt: z.date().describe('When the ticket expires'),
  via: z.string().describe('How the ticket was issued (e.g., login, password_reset)'),
  revokedAt: z.date().optional().describe('When the ticket was revoked, if applicable'),
