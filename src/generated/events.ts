...
declare global {
    interface EventRegistry {
        ...
        'cdn.site_composed': z.infer<typeof Contract_2.siteComposedEvent['schema']>;
        ...
        'site.created': z.infer<typeof Contract_2.siteCrud['create']['outputSchema']>;
        'site.updated': { id: string; patch: Record<string, unknown>; item: z.infer<typeof Contract_2.siteCrud['update']['outputSchema']> };
