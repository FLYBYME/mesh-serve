...
declare global {
    interface IServiceToolRegistry {
        ...
        'user.count': { params: z.input<typeof Contract_6.userCrud['count']['inputSchema']>, returns: z.infer<typeof Contract_6.userCrud['count']['outputSchema']> };
        'user.get': { params: z.input<typeof Contract_6.userCrud['get']['inputSchema']>, returns: z.infer<typeof Contract_6.userCrud['get']['outputSchema']> };
        'user.resolve': { params: z.input<typeof Contract_6.userCrud['resolve']['inputSchema']>, returns: z.infer<typeof Contract_6.userCrud['resolve']['outputSchema']> };
        'user.update': { params: z.input<typeof Contract_6.userCrud['update']['inputSchema']>, returns: z.infer<typeof Contract_6.userCrud['update']['outputSchema']> };
        'user.delete': { params: z.input<typeof Contract_6.userCrud['delete']['inputSchema']>, returns: z.infer<typeof Contract_6.userCrud['delete']['outputSchema']> };
        'organization.create': { params: z.input<typeof Contract_6.organizationCrud['create']['inputSchema']>, returns: z.infer<typeof Contract_6.organizationCrud['create']['outputSchema']> };
        'organization.find': { params: z.input<typeof Contract_6.organizationCrud['find']['inputSchema']>, returns: z.infer<typeof Contract_6.organizationCrud['find']['outputSchema']> };
        'organization.find_one': { params: z.input<typeof Contract_6.organizationCrud['findOne']['inputSchema']>, returns: z.infer<typeof Contract_6.organizationCrud['findOne']['outputSchema']> };
        'organization.count': { params: z.input<typeof Contract_6.organizationCrud['count']['inputSchema']>, returns: z.infer<typeof Contract_6.organizationCrud['count']['outputSchema']> };
        'organization.get': { params: z.input<typeof Contract_6.organizationCrud['get']['inputSchema']>, returns: z.infer<typeof Contract_6.organizationCrud['get']['outputSchema']> };
        'organization.resolve': { params: z.input<typeof Contract_6.organizationCrud['resolve']['inputSchema']>, returns: z.infer<typeof Contract_6.organizationCrud['resolve']['outputSchema']> };
        'organization.update': { params: z.input<typeof Contract_6.organizationCrud['update']['inputSchema']>, returns: z.infer<typeof Contract_6.organizationCrud['update']['outputSchema']> };
        'organization.delete': { params: z.input<typeof Contract_6.organizationCrud['delete']['inputSchema']>, returns: z.infer<typeof Contract_6.organizationCrud['delete']['outputSchema']> };
        'membership.create': { params: z.input<typeof Contract_6.membershipCrud['create']['inputSchema']>, returns: z.infer<typeof Contract_6.membershipCrud['create']['outputSchema']> };
        'membership.find': { params: z.input<typeof Contract_6.membershipCrud['find']['inputSchema']>, returns: z.infer<typeof Contract_6.membershipCrud['find']['outputSchema']> };
        'membership.find_one': { params: z.input<typeof Contract_6.membershipCrud['findOne']['inputSchema']>, returns: z.infer<typeof Contract_6.membershipCrud['findOne']['outputSchema']> };
        'membership.count': { params: z.input<typeof Contract_6.membershipCrud['count']['inputSchema']>, returns: z.infer<typeof Contract_6.membershipCrud['count']['outputSchema']> };
        'membership.get': { params: z.input<typeof Contract_6.membershipCrud['get']['inputSchema']>, returns: z.infer<typeof Contract_6.membershipCrud['get']['outputSchema']> };
        'membership.resolve': { params: z.input<typeof Contract_6.membershipCrud['resolve']['inputSchema']>, returns: z.infer<typeof Contract_6.membershipCrud['resolve']['outputSchema']> };
        'membership.update': { params: z.input<typeof Contract_6.membershipCrud['update']['inputSchema']>, returns: z.infer<typeof Contract_6.membershipCrud['update']['outputSchema']> };
        'membership.delete': { params: z.input<typeof Contract_6.membershipCrud['delete']['inputSchema']>, returns: z.infer<typeof Contract_6.membershipCrud['delete']['outputSchema']> };
        'role.create': { params: z.input<typeof Contract_6.roleCrud['create']['inputSchema']>, returns: z.infer<typeof Contract_6.roleCrud['create']['outputSchema']> };
        'role.find': { params: z.input<typeof Contract_6.roleCrud['find']['inputSchema']>, returns: z.infer<typeof Contract_6.roleCrud['find']['outputSchema']> };
        'role.find_one': { params: z.input<typeof Contract_6.roleCrud['findOne']['inputSchema']>, returns: z.infer<typeof Contract_6.roleCrud['findOne']['outputSchema']> };
        'role.count': { params: z.input<typeof Contract_6.roleCrud['count']['inputSchema']>, returns: z.infer<typeof Contract_6.roleCrud['count']['outputSchema']> };
        'role.get': { params: z.input<typeof Contract_6.roleCrud['get']['inputSchema']>, returns: z.infer<typeof Contract_6.roleCrud['get']['outputSchema']> };
        'role.resolve': { params: z.input<typeof Contract_6.roleCrud['resolve']['inputSchema']>, returns: z.infer<typeof Contract_6.roleCrud['resolve']['outputSchema']> };
        'role.update': { params: z.input<typeof Contract_6.roleCrud['update']['inputSchema']>, returns: z.infer<typeof Contract_6.roleCrud['update']['outputSchema']> };
        'role.delete': { params: z.input<typeof Contract_6.roleCrud['delete']['inputSchema']>, returns: z.infer<typeof Contract_6.roleCrud['delete']['outputSchema']> };
        'grant.create': { params: z.input<typeof Contract_6.grantCrud['create']['inputSchema']>, returns: z.infer<typeof Contract_6.grantCrud['create']['outputSchema']> };
        'grant.find': { params: z.input<typeof Contract_6.grantCrud['find']['inputSchema']>, returns: z.infer<typeof Contract_6.grantCrud['find']['outputSchema']> };
        'grant.find_one': { params: z.input<typeof Contract_6.grantCrud['findOne']['inputSchema']>, returns: z.infer<typeof Contract_6.grantCrud['findOne']['outputSchema']> };
        'grant.count': { params: z.input<typeof Contract_6.grantCrud['count']['inputSchema']>, returns: z.infer<typeof Contract_6.grantCrud['count']['outputSchema']> };
        'grant.get': { params: z.input<typeof Contract_6.grantCrud['get']['inputSchema']>, returns: z.infer<typeof Contract_6.grantCrud['get']['outputSchema']> };
        'grant.resolve': { params: z.input<typeof Contract_6.grantCrud['resolve']['inputSchema']>, returns: z.infer<typeof Contract_6.grantCrud['resolve']['outputSchema']> };
        'grant.update': { params: z.input<typeof Contract_6.grantCrud['update']['inputSchema']>, returns: z.infer<typeof Contract_6.grantCrud['update']['outputSchema']> };
        'grant.delete': { params: z.input<typeof Contract_6.grantCrud['delete']['inputSchema']>, returns: z.infer<typeof Contract_6.grantCrud['delete']['outputSchema']> };
        'ticket.create': { params: z.input<typeof Contract_6.ticketCrud['create']['inputSchema']>, returns: z.infer<typeof Contract_6.ticketCrud['create']['outputSchema']> };
        'ticket.find': { params: z.input<typeof Contract_6.ticketCrud['find']['inputSchema']>, returns: z.infer<typeof Contract_6.ticketCrud['find']['outputSchema']> };
        'ticket.find_one': { params: z.input<typeof Contract_6.ticketCrud['findOne']['inputSchema']>, returns: z.infer<typeof Contract_6.ticketCrud['findOne']['outputSchema']> };
        'ticket.count': { params: z.input<typeof Contract_6.ticketCrud['count']['inputSchema']>, returns: z.infer<typeof Contract_6.ticketCrud['count']['outputSchema']> };
        'ticket.get': { params: z.input<typeof Contract_6.ticketCrud['get']['inputSchema']>, returns: z.infer<typeof Contract_6.ticketCrud['get']['outputSchema']> };
        'ticket.resolve': { params: z.input<typeof Contract_6.ticketCrud['resolve']['inputSchema']>, returns: z.infer<typeof Contract_6.ticketCrud['resolve']['outputSchema']> };
        'ticket.update': { params: z.input<typeof Contract_6.ticketCrud['update']['inputSchema']>, returns: z.infer<typeof Contract_6.ticketCrud['update']['outputSchema']> };
        'ticket.delete': { params: z.input<typeof Contract_6.ticketCrud['delete']['inputSchema']>, returns: z.infer<typeof Contract_6.ticketCrud['delete']['outputSchema']> };
        'apiToken.create': { params: z.input<typeof Contract_6.apiTokenCrud['create']['inputSchema']>, returns: z.infer<typeof Contract_6.apiTokenCrud['create']['outputSchema']> };
        'apiToken.find': { params: z.input<typeof Contract_6.apiTokenCrud['find']['inputSchema']>, returns: z.infer<typeof Contract_6.apiTokenCrud['find']['outputSchema']> };
        'apiToken.find_one': { params: z.input<typeof Contract_6.apiTokenCrud['findOne']['inputSchema']>, returns: z.infer<typeof Contract_6.apiTokenCrud['findOne']['outputSchema']> };
        'apiToken.count': { params: z.input<typeof Contract_6.apiTokenCrud['count']['inputSchema']>, returns: z.infer<typeof Contract_6.apiTokenCrud['count']['outputSchema']> };
        'apiToken.get': { params: z.input<typeof Contract_6.apiTokenCrud['get']['inputSchema']>, returns: z.infer<typeof Contract_6.apiTokenCrud['get']['outputSchema']> };
        'apiToken.resolve': { params: z.input<typeof Contract_6.apiTokenCrud['resolve']['inputSchema']>, returns: z.infer<typeof Contract_6.apiTokenCrud['resolve']['outputSchema']> };
        'apiToken.update': { params: z.input<typeof Contract_6.apiTokenCrud['update']['inputSchema']>, returns: z.infer<typeof Contract_6.apiTokenCrud['update']['outputSchema']> };
        'apiToken.delete': { params: z.input<typeof Contract_6.apiTokenCrud['delete']['inputSchema']>, returns: z.infer<typeof Contract_6.apiTokenCrud['delete']['outputSchema']> };
    }
}
